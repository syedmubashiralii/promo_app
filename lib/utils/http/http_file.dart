...
class HttpFile extends Equatable {
  HttpFile({required this.path, this.bytes, String? name, int? size})
    : _id = uuid.v4(),
      _name = name,
      _size = size;
  ...
  @override
  List<Object?> get props => [_id, path, bytes, _name, _size];

  @override
  String toString() =>
      "HttpFile: ${{"id": _id, "path": path, "name": name, "size": size}}";
